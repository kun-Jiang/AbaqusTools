...
def extract_odb(working_directory, odb_file_name, output_option, output_suboption, dimension, specified_step, specified_frame):
...
if __name__ == '__main__':
    ...
    extract_odb(working_directory, odb_file, output_option, output_suboption, dimension, specified_step, specified_frame)
